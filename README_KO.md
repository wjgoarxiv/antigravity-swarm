...
예전 프로젝트가 Gemini-first swarm runner였다면, v0.2.2은 Antigravity용 큰 업데이트입니다. npm 설치, Antigravity plugin layout, ASW alias, hooks, subagents, LSP diagnostics, 그리고 CLI가 데이터를 넘길 때 context, git, model quota를 보여주는 HUD까지 포함합니다.
...
v0.2.2은 이름만 바꾼 버전이 아닙니다. script 중심 swarm에서 Antigravity workflow package로 중심을 옮겼습니다.
